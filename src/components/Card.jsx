...
export default function Card({ record }) {
  return (
    <Link to={`record/${record.catalogNumber}`} className="block">
      <div className="bg-black text-white shadow-lg rounded-b-md overflow-hidden hover:shadow-xl transform transition duration-100 hover:scale-[1.0065] hover:skew-[.005rad]">
        <img
